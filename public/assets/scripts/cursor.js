/*! MagicMouse.js - v1.2.0 * A lightweight javascript library to create some amazing effects for the mouse (cursor) on your website
	...
	var l = t.documentElement,
		...
		h = (c.testStyles = function (e, o, n, s) {
			var a,
				...
				h = r("div"),
				p = i();
			if (parseInt(n, 10)) for (; n--; ) ((d = r("div")).id = s ? s[n] : f + (n + 1)), h.appendChild(d);
		...
		(function () {
			...
			for (var u in a)
				if (a.hasOwnProperty(u)) {
					if (((e = []), (t = a[u]).name && (e.push(t.name.toLowerCase()), t.options && t.options.aliases && t.options.aliases.length))) for (o = 0; o < t.options.aliases.length; o++) e.push(t.options.aliases[o].toLowerCase());
